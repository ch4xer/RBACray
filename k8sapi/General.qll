...
newtype TApiCall =
  ...
  TClientGoCR(ClientGoCR::ApiCall call) or
...
class K8sApiCall extends TApiCall {
  ...
  ClientGoCR::ApiCall asClientGoCR() { this = TClientGoCR(result) }
  ...
  string toString() {
    ...
    or
    result = this.asClientGoCR().toString()
    or
  ...
  string getVerbName() {
    ...
    or
    result = this.asClientGoCR().getVerbName()
    or
  ...
  string getResourceName() {
    ...
    or
    result = this.asClientGoCR().getResourceName()
    or
  ...
  string getApiType() {
    ...
    or
    this instanceof TClientGoCR and result = "client-go-cr"
    or
  ...
  /**
   * 判断是否是 CustomResource 相关的调用：
   * - ClientGoCR 调用肯定是 CR
   * - ControllerRuntime 调用中，如果资源类型不在 k8s.io/api 包下，也是 CR
   */
  predicate isCustomResource() {
    this instanceof TClientGoCR
    or
    (this instanceof TControllerRuntime and this.asControllerRuntime().isCustomResource())
  }
}
